...
For the canonical list of supported platforms, providers, agents, integrations, and deployment paths with explicit status for each row, see [Platform Support and Launch Claims](../reference/platform-support).
