...
description: "Connect Telegram, Discord, Slack, WeChat, and WhatsApp to your sandboxed OpenClaw or Hermes agent, or Zalo to OpenClaw, using OpenShell-managed channel messaging."
description-agent: "Explains how Telegram, Discord, Slack, WeChat, and WhatsApp reach sandboxed OpenClaw and Hermes agents, and Zalo reaches OpenClaw, through OpenShell-managed processes and NemoClaw channel commands. Use when setting up messaging channels, chat interfaces, or integrations without relying on nemoclaw tunnel start for bridges."
