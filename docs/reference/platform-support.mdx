...
The engineering owner is the GitHub team auto-assigned to review changes to `ci/platform-matrix.json` through CODEOWNERS.
...
3. Open a PR. The engineering owner is auto-assigned through CODEOWNERS; tag the product owner for launch-facing claim changes.
