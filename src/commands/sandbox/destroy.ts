...
export default class DestroyCliCommand extends NemoClawCommand {
  ...
  static flags = {
    ...
    "cleanup-gateway": Flags.boolean({
      description:
        "When destroying the last sandbox, also tear down the shared NemoClaw gateway. Defaults to preserve on Linux and cleanup for unattended macOS destroys. NEMOCLAW_CLEANUP_GATEWAY overrides the platform default.",
      allowNo: true,
    }),
  };
